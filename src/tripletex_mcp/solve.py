"""FastAPI /solve endpoint — uses Gemini + Tripletex tools to complete accounting tasks."""
...
async def solve(
    ...
    for file in request.files:
        ...
        attachments.append(PreparedAttachment(filename=file.filename, mime_type=file.mime_type, data=data))

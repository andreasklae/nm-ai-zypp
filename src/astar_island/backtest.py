...
def _candidate_parameter_sets() -> list[PredictorParameters]:
    return [
        ...
        PredictorParameters(
            ...
            exact_weight=0.20,
            relaxed_weight=0.12,
            round_transition_weight=0.36,
            transition_weight=0.24,
            nearest_weight=0.06,
            cross_seed_nearest_weight=0.06,
            transition_alpha=1.4,
            round_transition_alpha=0.55,
            latent_proxy_strength=0.18,
        ...
        PredictorParameters(
            ...
            exact_weight=0.18,
            relaxed_weight=0.10,
            round_transition_weight=0.40,
            transition_weight=0.30,
            nearest_weight=0.05,
            cross_seed_nearest_weight=0.06,
            transition_alpha=1.2,
            round_transition_alpha=0.50,
            latent_proxy_strength=0.16,
            smoothing_base=0.02,
            smoothing_dynamic_scale=0.012,
        ),
    ]
